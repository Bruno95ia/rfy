...
VALUES (__ORG_ID__::uuid, '__ORG_NAME__')
ON CONFLICT (id) DO UPDATE
SET name = EXCLUDED.name;

INSERT INTO org_members(org_id, user_id, role)
VALUES (__ORG_ID__::uuid, __USER_ID__::uuid, 'owner')
ON CONFLICT (org_id, user_id) DO UPDATE
SET role = 'owner';

INSERT INTO org_subscriptions(org_id, plan_id, status, period_start, updated_at)
VALUES (__ORG_ID__::uuid, '__PLAN_ID__', 'active', now() - interval '7 days', now())
...
VALUES (__ORG_ID__::uuid, 25, 800, 5000, now())
ON CONFLICT (org_id) DO UPDATE
...
VALUES
  ('a7f6c321-6f8b-43ba-9519-111111111111'::uuid, __ORG_ID__::uuid, 'demo-opportunities.csv', 'demo/opportunities.csv', 'opportunities', 'done', now() - interval '2 days', now() - interval '2 days'),
  ('a7f6c321-6f8b-43ba-9519-222222222222'::uuid, __ORG_ID__::uuid, 'demo-activities.csv', 'demo/activities.csv', 'activities', 'done', now() - interval '1 day', now() - interval '1 day')
ON CONFLICT (id) DO UPDATE
...
VALUES
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-111111111111'::uuid, 'piperun', 'demo-opp-001', 'Enterprise', 'Proposta', 19, 'ana@rfy.local', 'Ana Clara', 'Atlas Energia', 'Expansao Nacional', 420000, current_date - 60, 'open'),
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-111111111111'::uuid, 'piperun', 'demo-opp-002', 'Enterprise', 'Proposta', 16, 'ana@rfy.local', 'Ana Clara', 'Norte Pharma', 'Plataforma Comercial', 280000, current_date - 45, 'open'),
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-111111111111'::uuid, 'piperun', 'demo-opp-003', 'Mid-Market', 'Negociacao', 11, 'bruno@rfy.local', 'Bruno Lima', 'Sigma Log', 'Rollout Filiais', 360000, current_date - 34, 'open'),
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-111111111111'::uuid, 'piperun', 'demo-opp-004', 'Mid-Market', 'Negociacao', 8, 'carla@rfy.local', 'Carla Souza', 'Delta Foods', 'Otimizacao RevenueOps', 240000, current_date - 29, 'open'),
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-111111111111'::uuid, 'piperun', 'demo-opp-005', 'SMB', 'Qualificacao', 6, 'carla@rfy.local', 'Carla Souza', 'Zen Motors', 'Expansao Inside Sales', 130000, current_date - 20, 'open'),
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-111111111111'::uuid, 'piperun', 'demo-opp-006', 'SMB', 'Fechado', 2, 'bruno@rfy.local', 'Bruno Lima', 'Kappa Medical', 'Renovacao Contrato', 175000, current_date - 15, 'won')
...
VALUES
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-222222222222'::uuid, 'demo-act-001', 'call', '[DEMO] Follow-up Proposta Atlas', 'Ana Clara', now() - interval '3 days', null, 'Atlas Energia', 'Expansao Nacional', 'Ana Clara', 'demo-opp-001', 'high'),
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-222222222222'::uuid, 'demo-act-002', 'email', '[DEMO] Reengajar Norte Pharma', 'Ana Clara', now() - interval '7 days', null, 'Norte Pharma', 'Plataforma Comercial', 'Ana Clara', 'demo-opp-002', 'high'),
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-222222222222'::uuid, 'demo-act-003', 'meeting', '[DEMO] Negociacao Sigma', 'Bruno Lima', now() - interval '4 days', null, 'Sigma Log', 'Rollout Filiais', 'Bruno Lima', 'demo-opp-003', 'high'),
  (__ORG_ID__::uuid, 'a7f6c321-6f8b-43ba-9519-222222222222'::uuid, 'demo-act-004', 'task', '[DEMO] Proposta Delta', 'Carla Souza', now() - interval '2 days', null, 'Delta Foods', 'Otimizacao RevenueOps', 'Carla Souza', 'demo-opp-004', 'high');
...
VALUES
  (__ORG_ID__::uuid, 'connect_crm', now() - interval '5 days', __USER_ID__::uuid, '{"seed":"demo_v1"}'::jsonb),
  (__ORG_ID__::uuid, 'first_upload', now() - interval '4 days', __USER_ID__::uuid, '{"seed":"demo_v1"}'::jsonb),
  (__ORG_ID__::uuid, 'alerts_setup', now() - interval '3 days', __USER_ID__::uuid, '{"seed":"demo_v1"}'::jsonb)
...
VALUES (
  ...
  '[DEMO] Ingest Key',
  'rfy_demo_',
  encode(digest('rfy-demo-key-' || __ORG_ID__, 'sha256'), 'hex'),
...
VALUES (__ORG_ID__::uuid, 'email', 'alerts-demo@rfy.local', '{"seed":"demo_v1"}'::jsonb, true);
...
VALUES
  (__ORG_ID__::uuid, 'pipeline-stagnation', 'high', 12, true, 30, '{}'::uuid[]),
  (__ORG_ID__::uuid, 'proposal-stuck', 'critical', 7, true, 15, '{}'::uuid[]);
...
VALUES
  (__ORG_ID__::uuid, '[DEMO] Base', '{"win_rate_delta":0,"cycle_days_delta":0}'::jsonb, true, __USER_ID__::uuid, now()),
  (__ORG_ID__::uuid, '[DEMO] Agressivo', '{"win_rate_delta":0.08,"cycle_days_delta":-12}'::jsonb, false, __USER_ID__::uuid, now());
...
VALUES
  (__ORG_ID__::uuid, date_trunc('month', now())::date - interval '2 month', 'smb', 120, 104, 0.8667, 14000, 3500),
  (__ORG_ID__::uuid, date_trunc('month', now())::date - interval '1 month', 'smb', 128, 114, 0.8906, 16200, 3100),
  (__ORG_ID__::uuid, date_trunc('month', now())::date, 'smb', 132, 119, 0.9015, 17100, 2800)
...
VALUES
  (__ORG_ID__::uuid, 'uploads_30d', 2, now() - interval '1 day', '{"seed":"demo_v1"}'::jsonb),
  (__ORG_ID__::uuid, 'active_deals', 6, now() - interval '2 hours', '{"seed":"demo_v1"}'::jsonb),
  (__ORG_ID__::uuid, 'api_calls', 14, now() - interval '3 hours', '{"seed":"demo_v1"}'::jsonb);
...
WHERE org_id = __ORG_ID__::uuid AND campaign_id = 'b7f6c321-6f8b-43ba-9519-000000000001'::uuid;
